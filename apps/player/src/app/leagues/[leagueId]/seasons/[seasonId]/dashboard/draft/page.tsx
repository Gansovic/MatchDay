...
export default function DraftSeasonDashboard() {
  ...
  const [teamRegistrations] = useState<TeamRegistration[]>([
    {
      id: '1',
      name: 'Thunder United',
      captain: 'John Smith',
      ...
      contactEmail: 'john@thunderunited.com'
    },
    {
      id: '2',
      name: 'Lightning FC',
      ...
      contactEmail: 'maria@lightningfc.com'
    },
    {
      id: '3',
      name: 'Storm Warriors',
      ...
      contactEmail: 'david@stormwarriors.com'
    }
  ]);
