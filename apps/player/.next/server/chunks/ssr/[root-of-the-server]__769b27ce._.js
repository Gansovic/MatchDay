...
"[project]/packages/database/src/database.types.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/database.types.ts [app-ssr] (ecmascript)");
;
}),
...
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/database.types.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/database/src/index.ts [app-ssr] (ecmascript) <locals>");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/packages/database/src/index.ts [app-ssr] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/database/src/database.types.ts [app-ssr] (ecmascript)");
;
class AchievementService {
   ...
   */ calculateCategoryProgress(allAchievements, userAchievements) {
        const categories = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AchievementCategory"]);
        const result = {};
    ...
    calculateDifficultyProgress(allAchievements, userAchievements) {
        const difficulties = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AchievementDifficulty"]);
        const result = {};
...
"[project]/packages/auth/src/auth.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class AuthService {
   ...
   */ async signUp(data) {
        try {
            ...
            if (authData.user) {
                ...
                const profileResult = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$edge$2d$functions$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EdgeFunctionsService"].getInstance().updateUserProfile({
   ...
   */ async updateProfile(updates) {
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$edge$2d$functions$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EdgeFunctionsService"].getInstance().updateUserProfile(updates);
            if (!result.success) {
                return {
...
"[project]/packages/auth/src/validator.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/auth/src/role.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
   ...
   */ static async getCurrentUserRole() {
        try {
            ...
            const userResult = await Promise.race([
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser(),
            ...
            for(let attempt = 1; attempt <= 2; attempt++){
                try {
                    const { data: profile, error } = await Promise.race([
                        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('id', user.id).single(),
   ...
   */ static async canManageLeague(leagueId) {
        try {
            ...
            if (userRole === 'league_admin') {
                const { data: { user } } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                if (!user) return false;
                const { data: league } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('leagues').select('created_by').eq('id', leagueId).single();
   ...
   */ static async canManageTeam(teamId) {
        try {
            ...
            if ([
                ...
                const { data: team } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('teams').select('captain_id').eq('id', teamId).single();
            ...
            if (userRole === 'league_admin') {
                const { data: team } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('teams').select('league_id, leagues!inner(created_by)').eq('id', teamId).single();
 ...
 */ __turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$auth$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/auth/src/auth.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/auth/src/validator.ts [app-ssr] (ecmascript)");
// api-auth is app-specific, not exported from shared package
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$role$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/auth/src/role.service.ts [app-ssr] (ecmascript)");
;
;
;
}),
"[project]/packages/auth/src/index.ts [app-ssr] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/player/src/lib/supabase/client.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/packages/auth/src/index.ts [app-ssr] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/auth/src/validator.ts [app-ssr] (ecmascript)");
'use client';
;
;
...
const AuthProvider = ({ children })=>{
    ...
    const validateAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        const validation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateAuthenticationState"])();
    ...
    const refreshSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            const { success, session: newSession } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["refreshAuthSession"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        refreshCheckInterval.current = setInterval(async ()=>{
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$auth$2f$src$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTokenNearExpiry"])(authState.session)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__769b27ce._.js.map