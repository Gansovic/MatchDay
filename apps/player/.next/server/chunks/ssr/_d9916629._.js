...
"[project]/packages/services/src/league.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class LeagueService {
   ...
   */ async discoverLeagues(filters = {}, options = {}) {
        try {
   ...
   */ async getLeagueDetails(leagueId, options = {}) {
        try {
            ...
            if (options.userId && teams.length > 0) {
                ...
                const userTeams = teams.filter((team)=>team.team_members?.some((member)=>member.user_id === options.userId && member.is_active));
   ...
   */ async getAvailableTeams(leagueId, options = {}) {
        try {
   ...
   */ subscribeToLeagueUpdates(leagueId, callback, options = {
        table: 'leagues',
        event: '*'
    }) {
        return this.supabase.channel(`league-${leagueId}-updates`).on('postgres_changes', {
            event: options.event,
...
"[project]/packages/services/src/team.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class TeamService {
   ...
   */ getCacheKey(operation, params) {
    ...
    /**
   * Create a new team
   */ async createTeam(captainId, teamData, options = {
   ...
   */ async getTeamSeasonYear(teamId) {
        ...
        const { data: matchYears } = await this.supabase.from('matches').select('match_date').or(`home_team_id.eq.${teamId},away_team_id.eq.${teamId}`).eq('status', 'completed').limit(1);
   ...
   */ subscribeToTeamUpdates(teamId, callback, options = {
        table: 'teams',
        event: '*'
    }) {
        return this.supabase.channel(`team-${teamId}-updates`).on('postgres_changes', {
            event: options.event,
            schema: options.schema || 'public',
            table: options.table,
...
"[project]/packages/services/src/match.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class MatchService {
   ...
   */ subscribeToMatchUpdates(matchId, callback, options = {
        table: 'match_events',
        event: '*'
    }) {
        return this.supabase.channel(`match-${matchId}-updates`).on('postgres_changes', {
            event: options.event,
            schema: options.schema || 'public',
            table: options.table,
...
"[project]/packages/services/src/season.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/services/src/player.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class PlayerService {
   ...
   */ async getPlayerProfile(userId, options = {}) {
        try {
   ...
   */ async getPlayerAchievements(userId, options = {}) {
        try {
   ...
   */ async getTeamJoinRequests(userId, options = {}) {
        try {
   ...
   */ async submitTeamJoinRequest(userId, teamId, options = {}) {
        try {
   ...
   */ subscribeToPlayerUpdates(userId, callback, options = {
        table: 'user_profiles',
        event: '*'
    }) {
        return this.supabase.channel(`player-${userId}-updates`).on('postgres_changes', {
            event: options.event,
            schema: options.schema || 'public',
            table: options.table,
...
"[project]/packages/services/src/user.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class UserService {
   ...
   */ async getUserProfile(userId) {
        ...
        try {
            ...
            const queryPromise = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('id', userId).single();
   ...
   */ async updateUserProfile(userId, updates) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').update({
                ...updates,
                updated_at: new Date().toISOString()
            }).eq('id', userId).select('*').single();
            if (error) {
   ...
   */ async createUserProfile(userId, profileData) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').insert({
                id: userId,
   ...
   */ async profileExists(userId) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id').eq('id', userId).maybeSingle();
            if (error) {
                return {
                    data: false,
                    error: {
...
"[project]/packages/services/src/stats.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class StatsService {
   ...
   */ async getPlayerPerformanceAnalysis(userId, options = {}) {
        try {
   ...
   */ async getGlobalRankings(statType, filters = {}, options = {}) {
        try {
   ...
   */ async getCrossLeagueComparison(userId, options = {}) {
        try {
   ...
   */ async getLeagueAnalytics(leagueId, options = {}) {
        try {
   ...
   */ generateCrossLeagueStatsFromPlayerStats(playerStats) {
    ...
    async calculatePerformanceTrends(userId, seasonYear, period = 'monthly', statTypes = [
        'goals',
        'assists',
        'performance'
    ]) {
        try {
            ...
            const trends = {};
            statTypes.forEach((statType)=>{
                trends[statType] = trendsData?.filter((t)=>t.stat_type === statType).map((t)=>({
                        period: t.period,
                        goals: t.goals || 0,
                        assists: t.assists || 0,
                        matches: t.matches || 0,
   ...
   */ subscribeToStatsUpdates(userId, callback, options = {
        table: 'player_stats',
        event: '*'
    }) {
        return this.supabase.channel(`stats-${userId}-updates`).on('postgres_changes', {
            event: options.event,
            schema: options.schema || 'public',
            table: options.table,
...
"[project]/packages/services/src/analytics.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/player/src/lib/types/database.types.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/services/src/achievement.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$types$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/player/src/lib/types/database.types.ts [app-ssr] (ecmascript)");
;
class AchievementService {
   ...
   */ calculateCategoryProgress(allAchievements, userAchievements) {
        const categories = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$types$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AchievementCategory"]);
        const result = {};
    ...
    calculateDifficultyProgress(allAchievements, userAchievements) {
        const difficulties = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$player$2f$src$2f$lib$2f$types$2f$database$2e$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AchievementDifficulty"]);
        const result = {};
   ...
   */ subscribeToAchievementUpdates(userId, callback, options = {
        table: 'user_achievements',
        event: '*'
    }) {
        return this.supabase.channel(`achievements-${userId}-updates`).on('postgres_changes', {
            event: options.event,
            schema: options.schema || 'public',
            table: options.table,
...
"[project]/packages/services/src/edge-functions.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/services/src/config.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/services/src/index.ts [app-ssr] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$league$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/league.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$team$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/team.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$match$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/match.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$season$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/season.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$player$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/player.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$user$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/user.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$stats$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/stats.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$analytics$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/analytics.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$achievement$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/achievement.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$edge$2d$functions$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/edge-functions.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$config$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/config.service.ts [app-ssr] (ecmascript)");
;
;
;
;
...
"[project]/packages/services/src/index.ts [app-ssr] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$edge$2d$functions$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/edge-functions.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$config$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/config.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/services/src/index.ts [app-ssr] (ecmascript) <locals>");
}),
"[project]/packages/services/src/index.ts [app-ssr] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "AchievementService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$achievement$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AchievementService"],
    "AnalyticsService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$analytics$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AnalyticsService"],
    "ConfigService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$config$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ConfigService"],
    "EdgeFunctionsService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$edge$2d$functions$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EdgeFunctionsService"],
    "LeagueService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$league$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LeagueService"],
    "MatchService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$match$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MatchService"],
    "PlayerService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$player$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PlayerService"],
    "SeasonService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$season$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SeasonService"],
    "StatsService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$stats$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StatsService"],
    "TeamService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$team$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamService"],
    "UserService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$user$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserService"],
    "configService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$config$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["configService"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$league$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/league.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$team$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/services/src/team.service.ts [app-ssr] (ecmascript)");
...
"[project]/packages/services/src/index.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "AchievementService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["AchievementService"],
    "AnalyticsService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["AnalyticsService"],
    "ConfigService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["ConfigService"],
    "EdgeFunctionsService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["EdgeFunctionsService"],
    "LeagueService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["LeagueService"],
    "MatchService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["MatchService"],
    "PlayerService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["PlayerService"],
    "SeasonService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["SeasonService"],
    "StatsService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["StatsService"],
    "TeamService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["TeamService"],
    "UserService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["UserService"],
    "configService": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["configService"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/packages/services/src/index.ts [app-ssr] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$services$2f$src$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/packages/services/src/index.ts [app-ssr] (ecmascript) <exports>");
}),

};

//# sourceMappingURL=_d9916629._.js.map