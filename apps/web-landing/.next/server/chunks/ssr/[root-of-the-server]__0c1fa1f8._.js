...
"[project]/apps/web-landing/src/lib/environment/validation.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web-landing/src/lib/supabase/client.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$environment$2f$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web-landing/src/lib/environment/validation.ts [app-ssr] (ecmascript)");
;
;
// Validate environment at startup to prevent database confusion
(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$environment$2f$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateEnvironmentAtStartup"])();
// Get validated environment configuration
const envConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$environment$2f$validation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getEnvironmentConfig"])();
...
"[project]/apps/web-landing/src/lib/auth/validator.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web-landing/src/lib/supabase/client.ts [app-ssr] (ecmascript)");
;
async function validateAuthenticationState() {
    try {
        console.log('🔍 Validating authentication state...');
        // Step 1: Check if we have a session
        const { data: { session }, error: sessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
        if (sessionError) {
            console.log('🔍 Session error:', sessionError.message);
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isInvalidJWTError"])(sessionError)) {
                return {
                    isValid: false,
...
async function validateSessionHealth(session) {
    ...
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
        if (error && (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isInvalidJWTError"])(error)) {
            console.log('🔍 Invalid JWT detected in health check');
            return false;
        }
        return !error && !!data.user;
    } catch (error) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isInvalidJWTError"])(error)) {
...
async function refreshAuthSession() {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.refreshSession();
        if (error) {
...
"[project]/apps/web-landing/src/components/auth/supabase-auth-provider.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web-landing/src/lib/supabase/client.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$auth$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web-landing/src/lib/auth/validator.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
const AuthProvider = ({ children })=>{
    ...
    const updateAuthState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (validation)=>{
        ...
        if (validation.shouldClearCookies) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearAuthCookies"])();
        }
    }, []);
    // Comprehensive authentication validation
    const validateAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        const validation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$auth$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateAuthenticationState"])();
    ...
    const refreshSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            const { success, session: newSession } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$auth$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["refreshAuthSession"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange(async (event, session)=>{
            if (!mounted.current) return;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$6_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        refreshCheckInterval.current = setInterval(async ()=>{
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$auth$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTokenNearExpiry"])(authState.session)) {
    ...
    const signUp = async (data)=>{
        try {
            ...
            const { data: authData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email: data.email,
    ...
    const signIn = async (data)=>{
        try {
            ...
            const { data: authData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: data.email,
                password: data.password
            });
            if (error) {
    ...
    const signInWithOAuth = async (provider)=>{
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
                provider,
                options: {
    ...
    const signOut = async ()=>{
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
            if (error) {
    ...
    const resetPassword = async (email)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.resetPasswordForEmail(email, {
...
const getSession = async ()=>{
    try {
        const { data: { session }, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
        if (error) {
...
"[project]/apps/web-landing/src/components/layout/header.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$components$2f$auth$2f$supabase$2d$auth$2d$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web-landing/src/components/auth/supabase-auth-provider.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
const Header = ({ className = '' })=>{
    ...
    const { user, isLoading, signOut, forceSignOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2d$landing$2f$src$2f$components$2f$auth$2f$supabase$2d$auth$2d$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
"[project]/apps/web-landing/src/components/providers/query-provider.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c1fa1f8._.js.map