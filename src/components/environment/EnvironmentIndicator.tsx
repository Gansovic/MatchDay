...
import { getEnvironmentDisplayName, getDatabaseDisplayName, validateEnvironment } from '@/lib/environment/validation'
...
/**
 * Environment Status Bar Component
 * 
