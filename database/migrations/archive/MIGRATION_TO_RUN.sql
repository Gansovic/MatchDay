-- IMPORTANT: Run this SQL in your Supabase database to enable season join requests
-- You can run this via:
-- 1. Supabase Dashboard SQL Editor: https://supabase.com/dashboard/project/twkipeacdamypppxmmhe/sql
-- 2. Any PostgreSQL client connected to your Supabase database
-- 3. Supabase CLI once properly linked
