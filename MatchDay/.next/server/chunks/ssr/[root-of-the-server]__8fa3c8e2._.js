...
const supabaseUrl = ("TURBOPACK compile-time value", "http://localhost:3003/api/mock-supabase");
...
function getAuthRedirectUrl(path = '/dashboard') {
    const baseUrl = ("TURBOPACK compile-time value", "http://localhost:3003") || 'http://localhost:3000';
    return `${baseUrl}${path}`;
}
}),
...
const AuthProvider = ({ children, supabaseClient = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"] })=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8fa3c8e2._.js.map