...
export default function SeasonManagement({
  ...
  console.log(`SeasonManagement: Received ${seasons?.length || 0} seasons for league ${leagueId}:`, seasons);
          ...
          <div className="space-y-4">
            {seasons.map((season) => (
              <Link
                ...
                className="block border border-gray-600 rounded-lg p-4 hover:border-gray-500 transition-colors bg-gray-800 hover:bg-gray-750"
              >
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h4 className="font-medium text-white hover:text-orange-400 transition-colors">
