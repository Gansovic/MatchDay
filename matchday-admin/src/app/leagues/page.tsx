...
export default function AdminLeaguesPage() {
  ...
  const adminDashboardService = AdminDashboardService.getInstance();
    ...
    const fetchLeagueData = async () => {
      ...
      try {
        ...
        if (result.success && result.data) {
          // Extract leagues with enhanced data
          const leaguesData = result.data.leagues.map(league => ({
            ...league,
          ...
          // Load pending requests for all leagues
          ...
          if (requestsResult.success && requestsResult.data) {
            ...
            // Update pending request counts per league
            const updatedLeagues = leaguesData.map(league => ({
              ...league,
              pendingRequests: requestsResult.data!.filter(req => req.league.id === league.id).length
            }));
