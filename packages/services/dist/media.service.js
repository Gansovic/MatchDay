...
export class MediaService {
     ...
     */
    async getSeasonIcon(seasonId, leagueId) {
        try {
     ...
     * Upload league icon
     */
    async uploadLeagueIcon(file, leagueId, userId) {
        try {
     ...
     * Upload season icon
     */
    async uploadSeasonIcon(file, seasonId, leagueId, userId) {
        try {
     ...
     * Delete league icon
     */
    async deleteLeagueIcon(leagueId, userId) {
        try {
     ...
     * Delete season icon
     */
    async deleteSeasonIcon(seasonId, userId) {
        try {
     ...
     */
    async getMatchMedia(matchId, filters) {
     ...
     */
    async uploadMatchMedia(file, matchId, userId, options) {
        return this.uploadMedia(file, {
            context_type: 'match_media',
            match_id: matchId,
            is_public: options?.is_public ?? true,
     ...
     */
    async getPlayerMedia(playerId, filters) {
        // For now, filter by context_type and use metadata
     ...
     */
    async uploadPlayerMedia(file, playerId, userId, options) {
     ...
     */
    async repostMedia(originalMediaId, playerId, userId) {
        ...
        try {
            ...
            const originalBucket = this.getBucketFromContext(originalMedia.context_type);
