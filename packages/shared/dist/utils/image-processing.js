 ...
 * Crop an image file
 */
export async function cropImage(file, cropOptions) {
    return new Promise((resolve, reject) => {
        ...
        img.onload = () => {
            ...
            ctx.drawImage(img, cropOptions.x, cropOptions.y, cropOptions.width, cropOptions.height, 0, 0, cropOptions.width, cropOptions.height);
            canvas.toBlob((blob) => {
                if (blob) {
                    resolve(blob);
                }
