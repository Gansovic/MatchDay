 ...
 */
export function calculateStandings(matches, teams, config = {}) {
 ...
 */
function sortStandings(standings, tiebreakers) {
 ...
 */
function calculateFormTrend(form) {
    if (form.length < 3)
        return 'stable';
 ...
 */
export function getPositionChanges(currentStandings, previousStandings) {
 ...
 */
export function shouldUpdateStandings(match) {
 ...
 */
export function updateStandingsFromMatch(currentStandings, match, teams, config) {
 ...
 */
export function getAffectedTeams(match) {
    if (!shouldUpdateStandings(match))
        return [];
