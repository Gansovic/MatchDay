 ...
 */
export async function findMatchByIdOrNumber(matchIdOrNumber) {
 ...
 */
export async function findMatchForScoreUpdate(matchIdOrNumber) {
    const supabase = await createServerSupabaseClient();
    const isUuid = matchIdOrNumber.includes('-') && matchIdOrNumber.length === 36;
    let query = supabase
        .from('matches')
...
//# sourceMappingURL=match-lookup.js.map