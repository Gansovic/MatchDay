...
export class SampleDataGenerator {
        ...
        for (let i = 0; i < teams.length; i++) {
            for (let j = 0; j < teams.length; j++) {
                if (i !== j) {
                    ...
                    matchId++;
                    if (matchId % 4 === 1)
                        matchDay++; // Increment match day every 4 matches
                }
            }
        }
     ...
     */
    static generatePlayerStats(matches, players) {
        const stats = [];
    ...
    static distributeGoals(match, homePlayers, awayPlayers, stats) {
    ...
    static assignGoalsToPlayers(totalGoals, players, stats, matchId) {
...
SampleDataGenerator.SAMPLE_TEAMS = [
    {
        id: 'sample-team-1',
        name: 'Arsenal FC',
        team_color: '#DC2626',
...
SampleDataGenerator.SAMPLE_PLAYERS = {
    'sample-team-1': [
...
//# sourceMappingURL=sample-data-generator.js.map